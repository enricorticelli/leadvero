...
Non-negotiable constraints for leadvero.
...
- [R-0001 Crawler safeguards are mandatory](./0001-crawler-safeguards.md)
- [R-0002 Access runtime configuration through the env module](./0002-runtime-config-and-provider-keys.md)

<!-- Add further NNNN-slug.md files as rules are extracted. -->

## Open TODOs

- No repository CI workflow files were found under `.github/workflows`, so additional CI-enforced rules were not drafted from code evidence.
