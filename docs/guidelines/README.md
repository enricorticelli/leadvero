...
Conventions for style, naming, and non-architectural patterns in leadvero.
...
- [GL-0001 Keep App Router handlers thin](./0001-thin-route-handlers.md)
- [GL-0002 Validate API inputs with local Zod schemas](./0002-api-validation-pattern.md)
- [GL-0003 Organize tests by subsystem and mock external boundaries](./0003-test-organization-and-mocking.md)
